...
line : minute_sequence ' ' hour_sequence ' ' day_of_month_sequence ' ' month_sequence ' ' day_of_week_sequence ' ' (year_sequence ' ')? command;
...
year_sequence : arithmetical | explicit | all | range;
